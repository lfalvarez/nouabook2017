...
def word_i18n(request):
	...
	tag_extras['economie'] = _(u"Coopération")
	tag_extras['economie'] = _(u"Privatisation")
	tag_extras['economie'] = _(u"Economie Sociale")
	tag_extras['economie'] = _(u"Energie et Mines")
	tag_extras['economie'] = _(u"Eaux et Forêts")
	tag_extras['economie'] = _(u"Affaires Publiques")
	tag_extras['economie'] = _(u"Habous")
	tag_extras['economie'] = _(u"Urbanisme")
	tag_extras['economie'] = _(u"Régionalisation")
	tag_extras['economie'] = _(u"Anciens Combattants")
	tag_extras['economie'] = _(u"Commerce Intérieur")
	tag_extras['economie'] = _(u"Secrétariat Général du Gouvernement")
	tag_extras['economie'] = _(u"Cour des Comptes")
